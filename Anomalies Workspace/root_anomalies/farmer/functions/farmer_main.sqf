...
explozie = "root_anomalies\main\sounds\punch_7.ogg";
pietre = "root_anomalies\main\sounds\pietre.ogg";
travel_ground = "root_anomalies\main\sounds\travel_ground.ogg";
eko = "root_anomalies\main\sounds\eko.ogg";
...
FARMER_show_farmer = {
	...
	uiSleep 1;
	playSound3D ["root_anomalies\main\sounds\eko.ogg", "", false, [getPos _farmer select 0, getPos _farmer select 1, 1000], 20, 5, 0];
};
...
playSound3D ["root_anomalies\main\sounds\eko.ogg", "", false, [getPos _farmer select 0, getPos _farmer select 1, 100], 20, 5, 0];
