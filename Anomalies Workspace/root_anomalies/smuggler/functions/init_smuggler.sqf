...
/* 
null = [marker, mobile_anomaly, device_detector, spawn_classname, delay_between_spawn, teleport_protect] execVM "root_anomalies\smuggler\functions\smuggler_main.sqf";
...
["Smuggler Anomaly Settings", [
	...
	["TOOLBOX:YESNO", ["Disable Sensitive Lights", "If true, Bright lights will be disabled during teleportation. Highly recommended for people with sensitivity to lights."], false]
		...
		[_smugglerMarkerName, _isroaming, _detectdevice, _spawnobjects, _spawnobjectsdelay, _protectdevice, _dmg_on_teleport, _noseizure] remoteExec ["Root_fnc_SmugglerMain", 2];
	}, {
