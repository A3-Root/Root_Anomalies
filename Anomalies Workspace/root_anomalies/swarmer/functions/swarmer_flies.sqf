...
drop [["\A3\animals_f\fly.p3d", 1, 0, 1, 1], "", "SpaceObject", 1, 0.5, _this, flow_back, 0, 10, 7.9, 0, [6], [[1, 1, 1, 1]], [1], 1, 1, "", "root_anomalies\swarmer\functions\swarmer_flies.sqf", _this];
