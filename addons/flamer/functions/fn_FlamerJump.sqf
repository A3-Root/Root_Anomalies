 ...
 * Description: Local landing-fire FX where the Flamer leaps. Scorches a crater.
 *
 * Arguments:
...
private _burnGround = "Crater" createVehicleLocal [getPosATL _flamer select 0, getPosATL _flamer select 1, 0];
