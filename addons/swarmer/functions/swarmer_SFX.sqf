...
while {alive _stup} do
{
	...
	_flow_self = (getPosATL _stup vectorFromTo (_stup getRelPos [10, 0])) vectorMultiply 3;
	_roi_SFX setParticleParams [["\A3\animals_f\fly.p3d", 1, 0, 1, 1],"", "SpaceObject", 1,_life_fct,[0, 0, 0],[_flow_self select 0,_flow_self select 1, 0], 0, 10, 7.9, 0,[6],[[1, 1, 1, 1]],[1], 1, 1,"", "\z\root_anomalies\addons\swarmer\functions\swarmer_flies.sqf", _stup, 0];
