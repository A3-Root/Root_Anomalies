...
private _seizureSafe = _logic getVariable ["ROOT_TWINS_SEIZURESAFE", false];
...
[_twins, _trackDist, _sparks, _dmgRange, _affectAI, _emp, _heartClass, _seizureSafe, _config] call FUNC(TwinsMain);
