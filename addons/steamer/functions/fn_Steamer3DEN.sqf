...
private _config = [_logic, "steamer"] call root_anomalies_main_fnc_cfgCapture;
[_markerName, _territory, _damage, _recharge, _deathDamage, _travelPath, _config] call root_anomalies_steamer_fnc_SteamerMain;
